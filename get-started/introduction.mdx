...
<CardGroup cols={2}>
    ...
    <Card title="Blazing-Fast" icon="bolt">
        High performance and scalability are our priority, so we don't slow you down
    </Card>
    ...
    <Card title="Open Source" icon="people-group">
        We are welcome all kind of feedback and contributions in Glide. Let's make it work in the best possible way for you!
    </Card>
</CardGroup>
...
<CardGroup cols={2}>
    <Card href="/get-started/docker/" title="Docker" icon="docker" color="#0078d3">
